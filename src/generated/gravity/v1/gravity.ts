...
/**
 * PersistentGravityTasksResponse: this message repeats in
 * GetPersistentGravityTasksResponse
 */
export interface PersistentGravityTasksResponse {
...
export interface GetPersistentGravityTasksResponse {
  ...
  persistentGravityTasks: PersistentGravityTasksResponse[];
}
...
function createBasePersistentGravityTasksResponse(): PersistentGravityTasksResponse {
  return { gravityTaskId: "", ingestDt: "" };
}

export const PersistentGravityTasksResponse: MessageFns<PersistentGravityTasksResponse> =
  {
    encode(
      message: PersistentGravityTasksResponse,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
    ...
    decode(
      input: BinaryReader | Uint8Array,
      length?: number,
    ): PersistentGravityTasksResponse {
      const reader =
        input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = createBasePersistentGravityTasksResponse();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    fromJSON(object: any): PersistentGravityTasksResponse {
      return {
    ...
    toJSON(message: PersistentGravityTasksResponse): unknown {
      const obj: any = {};
      if (message.gravityTaskId !== "") {
    ...
    create(
      base?: DeepPartial<PersistentGravityTasksResponse>,
    ): PersistentGravityTasksResponse {
      return PersistentGravityTasksResponse.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<PersistentGravityTasksResponse>,
    ): PersistentGravityTasksResponse {
      const message = createBasePersistentGravityTasksResponse();
...
export const GetPersistentGravityTasksResponse: MessageFns<GetPersistentGravityTasksResponse> =
  {
    encode(
      ...
      for (const v of message.persistentGravityTasks) {
        PersistentGravityTasksResponse.encode(
          v!,
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.persistentGravityTasks.push(
              PersistentGravityTasksResponse.decode(reader, reader.uint32()),
            );
            continue;
          }
        }
      ...
      return {
        persistentGravityTasks: globalThis.Array.isArray(
          ...
          ? object.persistentGravityTasks.map((e: any) =>
              PersistentGravityTasksResponse.fromJSON(e),
            )
          : [],
      };
    },
    ...
    toJSON(message: GetPersistentGravityTasksResponse): unknown {
      ...
      if (message.persistentGravityTasks?.length) {
        obj.persistentGravityTasks = message.persistentGravityTasks.map(e =>
          PersistentGravityTasksResponse.toJSON(e),
        );
      }
      return obj;
    },
    ...
    fromPartial(
      ...
      message.persistentGravityTasks =
        object.persistentGravityTasks?.map(e =>
          PersistentGravityTasksResponse.fromPartial(e),
        ) || [];
      return message;
    },
  };
...
export const GetMarketplaceDatasetsResponse: MessageFns<GetMarketplaceDatasetsResponse> =
  {
    ...
    fromJSON(object: any): GetMarketplaceDatasetsResponse {
      return {
        datasets: globalThis.Array.isArray(object?.datasets)
          ? object.datasets.map((e: any) => GravityTaskState.fromJSON(e))
          : [],
      };
    },
    ...
    toJSON(message: GetMarketplaceDatasetsResponse): unknown {
      const obj: any = {};
      if (message.datasets?.length) {
        obj.datasets = message.datasets.map(e => GravityTaskState.toJSON(e));
      }
      return obj;
    },
    ...
    fromPartial(
      ...
      const message = createBaseGetMarketplaceDatasetsResponse();
      message.datasets =
        object.datasets?.map(e => GravityTaskState.fromPartial(e)) || [];
      return message;
    },
  };
