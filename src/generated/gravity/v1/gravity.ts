...
function createBaseUpsertRawMinerFilesRequest(): UpsertRawMinerFilesRequest {
  return { crawlerId: "", parquetPaths: [], pathSizes: [] };
}

export const UpsertRawMinerFilesRequest: MessageFns<UpsertRawMinerFilesRequest> =
  {
    encode(
    ...
    fromJSON(object: any): UpsertRawMinerFilesRequest {
      return {
        ...
        pathSizes: globalThis.Array.isArray(object?.pathSizes)
          ? object.pathSizes.map((e: any) => globalThis.Number(e))
          : [],
      };
    },

    toJSON(message: UpsertRawMinerFilesRequest): unknown {
      const obj: any = {};
      if (message.crawlerId !== "") {
    ...
    create(
      base?: DeepPartial<UpsertRawMinerFilesRequest>,
    ): UpsertRawMinerFilesRequest {
      return UpsertRawMinerFilesRequest.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<UpsertRawMinerFilesRequest>,
    ): UpsertRawMinerFilesRequest {
      const message = createBaseUpsertRawMinerFilesRequest();
...
function createBaseChargeForDatasetRowsRequest(): ChargeForDatasetRowsRequest {
  return { crawlerId: "", rowCount: 0 };
}

export const ChargeForDatasetRowsRequest: MessageFns<ChargeForDatasetRowsRequest> =
  {
    encode(
    ...
    fromJSON(object: any): ChargeForDatasetRowsRequest {
      return {
        crawlerId: isSet(object.crawlerId)
          ? globalThis.String(object.crawlerId)
          : "",
    ...
    toJSON(message: ChargeForDatasetRowsRequest): unknown {
      const obj: any = {};
      if (message.crawlerId !== "") {
        obj.crawlerId = message.crawlerId;
      }
    ...
    create(
      base?: DeepPartial<ChargeForDatasetRowsRequest>,
    ): ChargeForDatasetRowsRequest {
      return ChargeForDatasetRowsRequest.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<ChargeForDatasetRowsRequest>,
    ): ChargeForDatasetRowsRequest {
      const message = createBaseChargeForDatasetRowsRequest();
      message.crawlerId = object.crawlerId ?? "";
      message.rowCount = object.rowCount ?? 0;
    ...
    fromJSON(object: any): CrawlerRawMinerFilesResponse {
      return {
        ...
        fileSizeBytes: globalThis.Array.isArray(object?.fileSizeBytes)
          ? object.fileSizeBytes.map((e: any) => globalThis.Number(e))
          : [],
      };
    },
...
function createBaseGetMarketplaceCrawlerDataForDDSubmissionRequest(): GetMarketplaceCrawlerDataForDDSubmissionRequest {
  return { marketplaceUserId: "" };
}

export const GetMarketplaceCrawlerDataForDDSubmissionRequest: MessageFns<GetMarketplaceCrawlerDataForDDSubmissionRequest> =
  {
    encode(
    ...
    decode(
      ...
      let end = length === undefined ? reader.len : reader.pos + length;
      const message =
        createBaseGetMarketplaceCrawlerDataForDDSubmissionRequest();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    fromJSON(object: any): GetMarketplaceCrawlerDataForDDSubmissionRequest {
      return {
    ...
    toJSON(message: GetMarketplaceCrawlerDataForDDSubmissionRequest): unknown {
      const obj: any = {};
      if (message.marketplaceUserId !== "") {
    ...
    create(
      base?: DeepPartial<GetMarketplaceCrawlerDataForDDSubmissionRequest>,
    ): GetMarketplaceCrawlerDataForDDSubmissionRequest {
      return GetMarketplaceCrawlerDataForDDSubmissionRequest.fromPartial(
        base ?? {},
      );
    },
    fromPartial(
      object: DeepPartial<GetMarketplaceCrawlerDataForDDSubmissionRequest>,
    ): GetMarketplaceCrawlerDataForDDSubmissionRequest {
      const message =
        createBaseGetMarketplaceCrawlerDataForDDSubmissionRequest();
...
function createBaseGetMarketplaceCrawlerDataForDDSubmissionResponse(): GetMarketplaceCrawlerDataForDDSubmissionResponse {
  return { crawlers: [] };
}

export const GetMarketplaceCrawlerDataForDDSubmissionResponse: MessageFns<GetMarketplaceCrawlerDataForDDSubmissionResponse> =
  {
    encode(
      ...
      for (const v of message.crawlers) {
        MarketplaceCrawlerDataForDDSubmission.encode(
          v!,
          writer.uint32(10).fork(),
        ).join();
      }
    ...
    decode(
      input: BinaryReader | Uint8Array,
      length?: number,
    ): GetMarketplaceCrawlerDataForDDSubmissionResponse {
      const reader =
        input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message =
        createBaseGetMarketplaceCrawlerDataForDDSubmissionResponse();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            ...
            message.crawlers.push(
              MarketplaceCrawlerDataForDDSubmission.decode(
                reader,
                reader.uint32(),
              ),
            );
    ...
    fromJSON(object: any): GetMarketplaceCrawlerDataForDDSubmissionResponse {
      return {
        crawlers: globalThis.Array.isArray(object?.crawlers)
          ? object.crawlers.map((e: any) =>
              MarketplaceCrawlerDataForDDSubmission.fromJSON(e),
            )
          : [],
      };
    },

    toJSON(message: GetMarketplaceCrawlerDataForDDSubmissionResponse): unknown {
      const obj: any = {};
      if (message.crawlers?.length) {
        obj.crawlers = message.crawlers.map(e =>
          MarketplaceCrawlerDataForDDSubmission.toJSON(e),
        );
      }
      return obj;
    },
    ...
    create(
      base?: DeepPartial<GetMarketplaceCrawlerDataForDDSubmissionResponse>,
    ): GetMarketplaceCrawlerDataForDDSubmissionResponse {
      return GetMarketplaceCrawlerDataForDDSubmissionResponse.fromPartial(
        base ?? {},
      );
    },
    fromPartial(
      object: DeepPartial<GetMarketplaceCrawlerDataForDDSubmissionResponse>,
    ): GetMarketplaceCrawlerDataForDDSubmissionResponse {
      const message =
        createBaseGetMarketplaceCrawlerDataForDDSubmissionResponse();
      message.crawlers =
        object.crawlers?.map(e =>
          MarketplaceCrawlerDataForDDSubmission.fromPartial(e),
        ) || [];
      return message;
    },
  };

function createBaseMarketplaceCrawlerDataForDDSubmission(): MarketplaceCrawlerDataForDDSubmission {
  return {
    crawlerId: "",
    platform: "",
    topic: undefined,
...
export const MarketplaceCrawlerDataForDDSubmission: MessageFns<MarketplaceCrawlerDataForDDSubmission> =
  {
    encode(
    ...
    decode(
      input: BinaryReader | Uint8Array,
      length?: number,
    ): MarketplaceCrawlerDataForDDSubmission {
      const reader =
        input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
    ...
    fromJSON(object: any): MarketplaceCrawlerDataForDDSubmission {
      return {
        crawlerId: isSet(object.crawlerId)
          ? globalThis.String(object.crawlerId)
          : "",
    ...
    toJSON(message: MarketplaceCrawlerDataForDDSubmission): unknown {
      const obj: any = {};
      if (message.crawlerId !== "") {
        obj.crawlerId = message.crawlerId;
      }
    ...
    create(
      base?: DeepPartial<MarketplaceCrawlerDataForDDSubmission>,
    ): MarketplaceCrawlerDataForDDSubmission {
      return MarketplaceCrawlerDataForDDSubmission.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<MarketplaceCrawlerDataForDDSubmission>,
    ): MarketplaceCrawlerDataForDDSubmission {
      const message = createBaseMarketplaceCrawlerDataForDDSubmission();
      message.crawlerId = object.crawlerId ?? "";
      message.platform = object.platform ?? "";
...
export const UpsertPreBuiltUserDatasetsRequest: MessageFns<UpsertPreBuiltUserDatasetsRequest> =
  {
    encode(
    ...
    decode(
      input: BinaryReader | Uint8Array,
      length?: number,
    ): UpsertPreBuiltUserDatasetsRequest {
      const reader =
        input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
    ...
    fromJSON(object: any): UpsertPreBuiltUserDatasetsRequest {
      return {
        gravityTaskId: isSet(object.gravityTaskId)
          ? globalThis.String(object.gravityTaskId)
          : "",
    ...
    toJSON(message: UpsertPreBuiltUserDatasetsRequest): unknown {
      const obj: any = {};
      if (message.gravityTaskId !== "") {
        obj.gravityTaskId = message.gravityTaskId;
      }
    ...
    create(
      base?: DeepPartial<UpsertPreBuiltUserDatasetsRequest>,
    ): UpsertPreBuiltUserDatasetsRequest {
      return UpsertPreBuiltUserDatasetsRequest.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<UpsertPreBuiltUserDatasetsRequest>,
    ): UpsertPreBuiltUserDatasetsRequest {
      const message = createBaseUpsertPreBuiltUserDatasetsRequest();
      message.gravityTaskId = object.gravityTaskId ?? "";
      message.crawlerId = object.crawlerId ?? "";
...
function createBaseGetPreBuiltUserDatasetsRequest(): GetPreBuiltUserDatasetsRequest {
  return { gravityTaskId: "" };
}

export const GetPreBuiltUserDatasetsRequest: MessageFns<GetPreBuiltUserDatasetsRequest> =
  {
    encode(
    ...
    decode(
      input: BinaryReader | Uint8Array,
      length?: number,
    ): GetPreBuiltUserDatasetsRequest {
      const reader =
        input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
    ...
    fromJSON(object: any): GetPreBuiltUserDatasetsRequest {
      return {
        gravityTaskId: isSet(object.gravityTaskId)
          ? globalThis.String(object.gravityTaskId)
          : "",
    ...
    toJSON(message: GetPreBuiltUserDatasetsRequest): unknown {
      const obj: any = {};
      if (message.gravityTaskId !== "") {
        obj.gravityTaskId = message.gravityTaskId;
      }
    ...
    create(
      base?: DeepPartial<GetPreBuiltUserDatasetsRequest>,
    ): GetPreBuiltUserDatasetsRequest {
      return GetPreBuiltUserDatasetsRequest.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<GetPreBuiltUserDatasetsRequest>,
    ): GetPreBuiltUserDatasetsRequest {
      const message = createBaseGetPreBuiltUserDatasetsRequest();
      message.gravityTaskId = object.gravityTaskId ?? "";
      return message;
...
function createBasePreBuiltUserDataset(): PreBuiltUserDataset {
  return { gravityTaskId: "", crawlerId: "", rowCount: 0 };
}

export const PreBuiltUserDataset: MessageFns<PreBuiltUserDataset> = {
  encode(
  ...
  fromJSON(object: any): PreBuiltUserDataset {
    return {
      gravityTaskId: isSet(object.gravityTaskId)
        ? globalThis.String(object.gravityTaskId)
        : "",
  ...
  toJSON(message: PreBuiltUserDataset): unknown {
    const obj: any = {};
    if (message.gravityTaskId !== "") {
      obj.gravityTaskId = message.gravityTaskId;
    }
  ...
  create(base?: DeepPartial<PreBuiltUserDataset>): PreBuiltUserDataset {
    return PreBuiltUserDataset.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PreBuiltUserDataset>): PreBuiltUserDataset {
    const message = createBasePreBuiltUserDataset();
    message.gravityTaskId = object.gravityTaskId ?? "";
    message.crawlerId = object.crawlerId ?? "";
    message.rowCount = object.rowCount ?? 0;
...
function createBaseGetPreBuiltUserDatasetsResponse(): GetPreBuiltUserDatasetsResponse {
  return { datasets: [] };
}

export const GetPreBuiltUserDatasetsResponse: MessageFns<GetPreBuiltUserDatasetsResponse> =
  {
    encode(
      ...
      for (const v of message.datasets) {
        PreBuiltUserDataset.encode(v!, writer.uint32(10).fork()).join();
      }
      return writer;
    },
    ...
    decode(
      input: BinaryReader | Uint8Array,
      length?: number,
    ): GetPreBuiltUserDatasetsResponse {
      const reader =
        input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.datasets.push(
              PreBuiltUserDataset.decode(reader, reader.uint32()),
            );
            continue;
          }
        }
    ...
    fromJSON(object: any): GetPreBuiltUserDatasetsResponse {
      return {
        datasets: globalThis.Array.isArray(object?.datasets)
          ? object.datasets.map((e: any) => PreBuiltUserDataset.fromJSON(e))
          : [],
      };
    },

    toJSON(message: GetPreBuiltUserDatasetsResponse): unknown {
      const obj: any = {};
      if (message.datasets?.length) {
        obj.datasets = message.datasets.map(e => PreBuiltUserDataset.toJSON(e));
      }
      return obj;
    },

    create(
      base?: DeepPartial<GetPreBuiltUserDatasetsResponse>,
    ): GetPreBuiltUserDatasetsResponse {
      return GetPreBuiltUserDatasetsResponse.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<GetPreBuiltUserDatasetsResponse>,
    ): GetPreBuiltUserDatasetsResponse {
      const message = createBaseGetPreBuiltUserDatasetsResponse();
      message.datasets =
        object.datasets?.map(e => PreBuiltUserDataset.fromPartial(e)) || [];
      return message;
    },
  };
...
export const GravityServiceService = {
  ...
  getMarketplaceCrawlerDataForDdSubmission: {
    ...
    responseStream: false,
    requestSerialize: (
      value: GetMarketplaceCrawlerDataForDDSubmissionRequest,
    ) =>
      Buffer.from(
        GetMarketplaceCrawlerDataForDDSubmissionRequest.encode(value).finish(),
      ),
    requestDeserialize: (value: Buffer) =>
      GetMarketplaceCrawlerDataForDDSubmissionRequest.decode(value),
    responseSerialize: (
      value: GetMarketplaceCrawlerDataForDDSubmissionResponse,
    ) =>
      Buffer.from(
        GetMarketplaceCrawlerDataForDDSubmissionResponse.encode(value).finish(),
      ),
    responseDeserialize: (value: Buffer) =>
      GetMarketplaceCrawlerDataForDDSubmissionResponse.decode(value),
  },
  ...
  chargeForDatasetRows: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ChargeForDatasetRowsRequest) =>
      Buffer.from(ChargeForDatasetRowsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      ChargeForDatasetRowsRequest.decode(value),
    responseSerialize: (value: UpsertResponse) =>
      Buffer.from(UpsertResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UpsertResponse.decode(value),
  },
  ...
  upsertRawMinerFiles: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpsertRawMinerFilesRequest) =>
      Buffer.from(UpsertRawMinerFilesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      UpsertRawMinerFilesRequest.decode(value),
    responseSerialize: (value: UpsertResponse) =>
      Buffer.from(UpsertResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UpsertResponse.decode(value),
  },
  ...
  upsertPreBuiltUserDatasets: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpsertPreBuiltUserDatasetsRequest) =>
      Buffer.from(UpsertPreBuiltUserDatasetsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      UpsertPreBuiltUserDatasetsRequest.decode(value),
    responseSerialize: (value: UpsertResponse) =>
      Buffer.from(UpsertResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UpsertResponse.decode(value),
  },
  ...
  getPreBuiltUserDatasets: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetPreBuiltUserDatasetsRequest) =>
      Buffer.from(GetPreBuiltUserDatasetsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) =>
      GetPreBuiltUserDatasetsRequest.decode(value),
    responseSerialize: (value: GetPreBuiltUserDatasetsResponse) =>
      Buffer.from(GetPreBuiltUserDatasetsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) =>
      GetPreBuiltUserDatasetsResponse.decode(value),
  },
} as const;
...
export interface GravityServiceServer extends UntypedServiceImplementation {
  ...
  >;
  /** Builds datasets for multiple crawlers within a single gravity task periodically */
  buildUserDatasetsPeriodically: handleUnaryCall<
    BuildAllDatasetsRequest,
    BuildAllDatasetsResponse
  >;
  /** Charges a user for dataset rows */
  chargeForDatasetRows: handleUnaryCall<
    ChargeForDatasetRowsRequest,
    UpsertResponse
  >;
  /** Gets crawler history for a gravity task */
  ...
  >;
  /** Upserts pre-built user dataset records */
  upsertPreBuiltUserDatasets: handleUnaryCall<
    UpsertPreBuiltUserDatasetsRequest,
    UpsertResponse
  >;
  /** Gets pre-built user dataset records for a gravity task */
  getPreBuiltUserDatasets: handleUnaryCall<
    GetPreBuiltUserDatasetsRequest,
    GetPreBuiltUserDatasetsResponse
  >;
}
...
export interface GravityServiceClient extends Client {
  ...
  getMarketplaceCrawlerDataForDdSubmission(
    ...
    callback: (
      error: ServiceError | null,
      response: GetMarketplaceCrawlerDataForDDSubmissionResponse,
    ) => void,
  ): ClientUnaryCall;
  getMarketplaceCrawlerDataForDdSubmission(
    request: GetMarketplaceCrawlerDataForDDSubmissionRequest,
  ...
  /** Charges a user for dataset rows */
  chargeForDatasetRows(
    request: ChargeForDatasetRowsRequest,
    callback: (error: ServiceError | null, response: UpsertResponse) => void,
  ): ClientUnaryCall;
  chargeForDatasetRows(
    request: ChargeForDatasetRowsRequest,
  ...
  /** Upserts raw miner files (parquet paths) for a crawler */
  upsertRawMinerFiles(
    request: UpsertRawMinerFilesRequest,
    callback: (error: ServiceError | null, response: UpsertResponse) => void,
  ): ClientUnaryCall;
  upsertRawMinerFiles(
    request: UpsertRawMinerFilesRequest,
  ...
  /** Upserts pre-built user dataset records */
  upsertPreBuiltUserDatasets(
    request: UpsertPreBuiltUserDatasetsRequest,
    callback: (error: ServiceError | null, response: UpsertResponse) => void,
  ): ClientUnaryCall;
  upsertPreBuiltUserDatasets(
    request: UpsertPreBuiltUserDatasetsRequest,
  ...
  /** Gets pre-built user dataset records for a gravity task */
  getPreBuiltUserDatasets(
    request: GetPreBuiltUserDatasetsRequest,
    callback: (
      error: ServiceError | null,
      response: GetPreBuiltUserDatasetsResponse,
    ) => void,
  ): ClientUnaryCall;
  getPreBuiltUserDatasets(
    request: GetPreBuiltUserDatasetsRequest,
