...
import { CLIENT_NAME, VERSION, BASE_URL, GRAVITY_API_KEY } from '../../constants';
...
export class GravityClient {
  ...
  private createGrpcClient() {
    ...
    // Create gRPC client
    return new this.protoClient.GravityService(
      this.baseURL,
      combinedCreds
    );
  }
   ...
   */
  getGravityTasks = async (params: IGetGravityTasksRequest): Promise<IGetGravityTasksResponse> => {
    const client = this.createGrpcClient();
    
    return new Promise<IGetGravityTasksResponse>((resolve, reject) => {
      client.GetGravityTasks(params, (error: Error | null, response: IGetGravityTasksResponse) => {
        if (error) {
          reject(error);
          return;
        }
   ...
   */
  getCrawler = async (params: IGetCrawlerRequest): Promise<IGetCrawlerResponse> => {
    const client = this.createGrpcClient();
    
    return new Promise<IGetCrawlerResponse>((resolve, reject) => {
      client.GetCrawler(params, (error: Error | null, response: IGetCrawlerResponse) => {
        if (error) {
          reject(error);
          return;
        }
   ...
   */
  createGravityTask = async (params: ICreateGravityTaskRequest): Promise<ICreateGravityTaskResponse> => {
    const client = this.createGrpcClient();
    
    return new Promise<ICreateGravityTaskResponse>((resolve, reject) => {
      client.CreateGravityTask(params, (error: Error | null, response: ICreateGravityTaskResponse) => {
        if (error) {
          reject(error);
          return;
        }
   ...
   */
  buildDataset = async (params: IBuildDatasetRequest): Promise<IBuildDatasetResponse> => {
    const client = this.createGrpcClient();
    
    return new Promise<IBuildDatasetResponse>((resolve, reject) => {
      client.BuildDataset(params, (error: Error | null, response: IBuildDatasetResponse) => {
        if (error) {
          reject(error);
          return;
        }
   ...
   */
  getDataset = async (params: IGetDatasetRequest): Promise<IGetDatasetResponse> => {
    const client = this.createGrpcClient();
    
    return new Promise<IGetDatasetResponse>((resolve, reject) => {
      client.GetDataset(params, (error: Error | null, response: IGetDatasetResponse) => {
        if (error) {
          reject(error);
          return;
        }
   ...
   */
  cancelGravityTask = async (params: ICancelGravityTaskRequest): Promise<ICancelGravityTaskResponse> => {
    const client = this.createGrpcClient();
    
    return new Promise<ICancelGravityTaskResponse>((resolve, reject) => {
      client.CancelGravityTask(params, (error: Error | null, response: ICancelGravityTaskResponse) => {
        if (error) {
          reject(error);
          return;
        }
   ...
   */
  cancelDataset = async (params: ICancelDatasetRequest): Promise<ICancelDatasetResponse> => {
    const client = this.createGrpcClient();
    
    return new Promise<ICancelDatasetResponse>((resolve, reject) => {
      client.CancelDataset(params, (error: Error | null, response: ICancelDatasetResponse) => {
        if (error) {
          reject(error);
          return;
        }
